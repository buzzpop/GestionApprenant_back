 ...
 */
final class Version20201116135541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD profil_id INT NOT NULL, ADD address VARCHAR(255) NOT NULL, ADD tel INT NOT NULL, ADD user_type VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP profil_id, DROP address, DROP tel, DROP user_type');
    }
}
